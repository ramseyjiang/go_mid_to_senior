...
func (c *calculateServiceClient) Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.CalculateService/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculateServiceClient) Sub(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.CalculateService/Sub", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculateServiceClient) Mul(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.CalculateService/Mul", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CalculateService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CalculateService/Add",
	}
...
func _CalculateService_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CalculateService/Sub",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CalculateService_Mul_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CalculateService/Mul",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
