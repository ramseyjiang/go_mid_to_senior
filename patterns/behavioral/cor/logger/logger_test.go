...
func TestCreateDefaultChain(t *testing.T) {
	...
	t.Run("3 loggers, 1 and 3 write to console, second if it founds "+"the word 'hello', 3 writes to some variable if the second found",
		func(t *testing.T) {
	...
	t.Run("2 loggers, 2nd uses the closure implementation", func(t *testing.T) {
		myWriter = myTestWriter{}
