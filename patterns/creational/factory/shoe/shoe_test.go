...
func TestSlipper(t *testing.T) {
	slipper, _ := CreateShoe("Slipper", 41, "Male", 200)
...
func TestSandal(t *testing.T) {
	sandal, _ := CreateShoe("Sandal", 42, "Male", 1000)
...
func TestBucks(t *testing.T) {
	bucks, _ := CreateShoe("Bucks", 38, "Female", 100)
...
func TestNoneShoeType(t *testing.T) {
	_, err := CreateShoe("test", 38, "Female", 100)
	if err == nil {
